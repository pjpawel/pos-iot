...
private_key_stream = BytesIO(bytes(private_key_str, "utf-8"))
...
public_key_stream = BytesIO(bytes(public_key_str, "utf-8"))

public_key_new = serialization.load_pem_public_key(public_key_stream.read())
