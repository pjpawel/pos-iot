...
./compose-start.sh 7 1 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
...
./compose-start.sh 8 0 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
...
./compose-start.sh 9 0 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
...
./compose-start.sh 10 0 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
...
./compose-start.sh 11 0 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
...
./compose-start.sh 2 0 "$NODE_NUMBER"
sleep "$SLEEP_TIME"
./compose-stop.sh
